...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BINLIBDEST': '/media/ryxen/New Volume/MLprojects/venv/lib/python3.12',
 'BLDLIBRARY': 'libpython3.12.a',
 'BLDSHARED': 'gcc -pthread -B /media/ryxen/New Volume/MLprojects/venv/compiler_compat -shared  '
              ''
              ''
              '-Wl,-rpath,/media/ryxen/New Volume/MLprojects/venv/lib '
              '-Wl,-rpath-link,/media/ryxen/New Volume/MLprojects/venv/lib '
              '-L/media/ryxen/New Volume/MLprojects/venv/lib '
              ''
              ''
              '-Wl,-rpath,/media/ryxen/New Volume/MLprojects/venv/lib '
              '-Wl,-rpath-link,/media/ryxen/New Volume/MLprojects/venv/lib '
 ...
 'BYTESTR_DEPS': '\\',
 'CC': 'gcc -pthread -B /media/ryxen/New Volume/MLprojects/venv/compiler_compat',
 'CCSHARED': '-fPIC',
 ...
 'CONFIG_ARGS': "'--prefix=/media/ryxen/New Volume/MLprojects/venv'"
                "'--build=x86_64-conda_cos6-linux-gnu'"
                "'--host=x86_64-conda_cos6-linux-gnu''--enable-ipv6'"
                "'--with-ensurepip=no'"
                "'--with-tzpath=/media/ryxen/New Volume/MLprojects/venv/share/zoneinfo:/media/ryxen/New Volume/MLprojects/venv/share/tzinfo'"
                "'--with-computed-gotos''--with-system-expat'"
                "'--enable-loadable-sqlite-extensions'"
                "'--with-tcltk-includes=-I/media/ryxen/New Volume/MLprojects/venv/include'"
                ...
                "'PKG_CONFIG_PATH=/media/ryxen/New Volume/MLprojects/venv/lib/pkgconfig'"
 ...
 'CPPFLAGS': '-IObjects -IInclude -IPython -I. '
             ...
             '/media/ryxen/New Volume/MLprojects/venv/include '
             '-I/media/ryxen/New Volume/MLprojects/venv/include',
 'CXX': 'g++ -pthread -B /media/ryxen/New Volume/MLprojects/venv/compiler_compat',
 ...
 'DESTDIRS': '/media/ryxen/New Volume/MLprojects/venv '
             '/media/ryxen/New Volume/MLprojects/venv/lib '
             '/media/ryxen/New Volume/MLprojects/venv/lib/python3.12 '
             '/media/ryxen/New Volume/MLprojects/venv/lib/python3.12/lib-dynload',
 'DESTLIB': '/media/ryxen/New Volume/MLprojects/venv/lib/python3.12',
 'DESTPATH': '',
 'DESTSHARED': '/media/ryxen/New Volume/MLprojects/venv/lib/python3.12/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'EXE': '',
 'EXEMODE': 755,
 'EXENAME': '/media/ryxen/New Volume/MLprojects/venv/bin/python3.12',
 'EXPORTSFROM': '',
 'EXPORTSYMS': '',
 'EXTRATESTOPTS': '',
 ...
 'INCLDIRSTOMAKE': '/media/ryxen/New Volume/MLprojects/venv/include '
                   '/media/ryxen/New Volume/MLprojects/venv/include '
                   '/media/ryxen/New Volume/MLprojects/venv/include/python3.12 '
                   '/media/ryxen/New Volume/MLprojects/venv/include/python3.12',
 'INCLUDEDIR': '/media/ryxen/New Volume/MLprojects/venv/include',
 'INCLUDEPY': '/media/ryxen/New Volume/MLprojects/venv/include/python3.12',
 ...
 'IO_OBJS': '\\',
 'LDCXXSHARED': 'g++ -pthread -B /media/ryxen/New Volume/MLprojects/venv/compiler_compat -shared',
 'LDFLAGS': ''
            ''
            '-Wl,-rpath,/media/ryxen/New Volume/MLprojects/venv/lib '
            '-Wl,-rpath-link,/media/ryxen/New Volume/MLprojects/venv/lib '
 ...
 'LDLIBRARYDIR': '',
 'LDSHARED': 'gcc -pthread -B /media/ryxen/New Volume/MLprojects/venv/compiler_compat -shared  '
             ''
             ''
             '-Wl,-rpath,/media/ryxen/New Volume/MLprojects/venv/lib '
             '-Wl,-rpath-link,/media/ryxen/New Volume/MLprojects/venv/lib '
 ...
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/media/ryxen/New Volume/MLprojects/venv/lib/pkgconfig',
 'LIBPL': '/media/ryxen/New Volume/MLprojects/venv/lib/python3.12/config-3.12-x86_64-linux-gnu',
 'LIBPYTHON': '',
 ...
 'LIBSUBDIRS': 'asyncio \\',
 'LINKCC': 'gcc -pthread -B /media/ryxen/New Volume/MLprojects/venv/compiler_compat',
 ...
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/media/ryxen/New Volume/MLprojects/venv/lib/python3.12',
 ...
 'MODULE_ZLIB_CFLAGS': '-I/media/ryxen/New Volume/MLprojects/venv/include',
 'MODULE_ZLIB_LDFLAGS': '-L/media/ryxen/New Volume/MLprojects/venv/lib '
                        '-lz',
 ...
 'MODULE__CURSES_CFLAGS': '-D_GNU_SOURCE -DNCURSES_WIDECHAR '
                          '-I/media/ryxen/New Volume/MLprojects/venv/include/ncursesw '
                          '-I/media/ryxen/New Volume/MLprojects/venv/include',
 'MODULE__CURSES_LDFLAGS': '-L/media/ryxen/New Volume/MLprojects/venv/lib '
                           ''
                           ''
                           '-Wl,-rpath,/media/ryxen/New Volume/MLprojects/venv/lib '
                           '-Wl,-rpath-link,/media/ryxen/New Volume/MLprojects/venv/lib '
 ...
 'MODULE__CURSES_PANEL_CFLAGS': '-D_GNU_SOURCE -DNCURSES_WIDECHAR '
                                ...
                                '-I/media/ryxen/New Volume/MLprojects/venv/include/ncursesw '
                                '-I/media/ryxen/New Volume/MLprojects/venv/include',
 'MODULE__CURSES_PANEL_LDFLAGS': '-L/media/ryxen/New Volume/MLprojects/venv/lib '
                                 ''
                                 ''
                                 '-Wl,-rpath,/media/ryxen/New Volume/MLprojects/venv/lib '
                                 '-Wl,-rpath-link,/media/ryxen/New Volume/MLprojects/venv/lib '
 ...
 'MODULE__LZMA_CFLAGS': '-I/media/ryxen/New Volume/MLprojects/venv/include',
 ...
 'MODULE__TKINTER_CFLAGS': '-I/media/ryxen/New Volume/MLprojects/venv/include '
                           '-Wno-strict-prototypes -DWITH_APPINIT=1',
 'MODULE__TKINTER_LDFLAGS': '-L/media/ryxen/New Volume/MLprojects/venv/lib '
 ...
 'MODULE__UUID_CFLAGS': '-I/media/ryxen/New Volume/MLprojects/venv/include/uuid',
 'MODULE__UUID_LDFLAGS': '-L/media/ryxen/New Volume/MLprojects/venv/lib '
                         '-luuid',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': '',
 'SCRIPTDIR': '/media/ryxen/New Volume/MLprojects/venv/lib',
